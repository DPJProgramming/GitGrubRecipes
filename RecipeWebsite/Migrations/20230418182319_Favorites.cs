    ...
    public partial class Favorites : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Favorites", x => new { x.FavoriteRecipesRecipeId, x.UsersFavoritedId });
                    table.ForeignKey(
                        name: "FK_Favorites_AspNetUsers_UsersFavoritedId",
                        column: x => x.UsersFavoritedId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Favorites_Recipes_FavoriteRecipesRecipeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UsersFavoritedId",
                table: "Favorites",
